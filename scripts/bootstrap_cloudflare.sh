...
echo "   wrangler secret put SEMRUSH_API_KEY"
echo "   wrangler secret put PLATFORM_ACCESS_CLIENT_ID"
echo "   wrangler secret put PLATFORM_ACCESS_CLIENT_SECRET"
echo "   wrangler secret put VACS_ACCESS_CLIENT_ID"
echo "   wrangler secret put VACS_ACCESS_CLIENT_SECRET"
echo "   wrangler secret put EVS_ACCESS_CLIENT_ID"
echo "   wrangler secret put EVS_ACCESS_CLIENT_SECRET"
echo ""
echo "   Transitional fallback only while cutover is in progress:"
echo "   wrangler secret put PLATFORM_SHARED_TOKEN"
echo "   wrangler secret put VACS_SHARED_TOKEN"
echo "   wrangler secret put EVS_SHARED_TOKEN"
echo ""
...
echo ""
echo "5. Preferred operator path:"
echo "   Use Keeper as the source of truth for Worker secrets."
echo "   Helper: bash scripts/zero_trust_worker_secret_cutover.sh"
echo "   Search Intelligence also requires SEMRUSH_API_KEY in the Worker runtime."
echo ""
