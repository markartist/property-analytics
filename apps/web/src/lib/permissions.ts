...
export type SurfaceAction = "view" | "draft" | "approve" | "administer" | "handoff" | "schedule" | "pause" | "rollback" | "decide";
...
export const OFFERING_ACCESS: Record<SurfaceId, SurfaceAccessDefinition> = {
  ...
  captainOffice: {
    ...
    actions: { view: "editor", draft: "editor", approve: "admin", administer: "admin" },
    audience: "curator",
    summary: "Governed property intelligence workspace over Captain Runtime, evidence, lineage, and candidate memory.",
  },
  pibBuilder: {
    id: "pibBuilder",
    href: "/analysis/pib",
  ...
  directiveControlCenter: {
    id: "directiveControlCenter",
    href: "/admin/directives",
    label: "Directive Control Center",
    category: "Validation",
    minRole: "admin",
    actionRole: "admin",
    actions: { view: "admin", draft: "admin", approve: "admin", administer: "admin", rollback: "admin" },
    audience: "steward",
    summary: "Governed policy control surface for Captain, Fleet, Expert Bench, and Fleet Scribe directives.",
  },
  siteContent: {
    id: "siteContent",
    href: "/site-content",
  ...
  experiments: {
    ...
    audience: "steward",
    summary: "Governed edge experimentation drafts, readiness gates, and decision ledger.",
  },
  vacs: {
    id: "vacs",
    href: "/vacs",
