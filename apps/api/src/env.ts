...
export interface Env {
  ...
  RESI_EDGE_PROMO_SYNC_ENABLED?: string;
  RESI_EDGE_PROMO_FEED_URL?: string;
  RESI_EDGE_HERO_FRESHNESS_SYNC_ENABLED?: string;
  RESI_EDGE_HERO_MEDIA_QUEUE_ENABLED?: string;
  RESI_EDGE_HERO_MEDIA_REFRESH_QUEUE?: Queue;
}
