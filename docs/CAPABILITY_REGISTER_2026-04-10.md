...
| BI export normalization and missing-metric audits | Pilot Monitoring / Data Quality | Specialized | pilot_control_cwv | `/Users/mark/Property_Analytics/pilot_control_cwv/scripts/` | BI dashboard exports from the shared `Guest_Card_Reports` drop | Snapshot history, audits, normalized series, and backfill/catch-up ingestion of archived BI run workbooks into `bi_normalized_metrics` | Tracker packaging scripts | Keep |
