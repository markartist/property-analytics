...
- Townestone at 359 (`TX4FC`, `townestoneat359.com`) is now the active canary for release token `2026-08-13.townestone-promo-bar-v2`, not the older Champions v1 proof. Active token file: `/Users/mark/Property_Analytics/config/portfolio_resi_edge_stabilization/resi-edge-release-tokens.v1.json`; canary manifest: `/Users/mark/Property_Analytics/config/portfolio_resi_edge_stabilization/townestoneat359-com-v2-canary.manifest.json`.
