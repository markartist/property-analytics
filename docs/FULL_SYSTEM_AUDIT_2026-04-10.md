...
- The report joins GA4 owned-site performance with GSC search-demand facts, classifies GSC query rows per property, and produces strict-discovery non-brand rollups by `encasa_region`. The workbook contains the full top 10 terms per group plus group summary, channel mix, monthly trend, brand/non-brand mix, intent clusters, property opportunities, paid/organic overlap, Ahrefs, and source coverage. DataForSEO was intentionally removed from the Andrew packet because stored coverage was too thin for a portfolio-grade executive read.
- Two Keeper-backed backfill helpers now support this reporting lane: `/Users/mark/Property_Analytics/scripts/backfill_portfolio_gsc_queries.py` for query rows and `/Users/mark/Property_Analytics/scripts/backfill_portfolio_gsc_daily.py` for daily GSC performance. They write auditable run packets under `/Users/mark/Property_Analytics/reports/adhoc_executive/andrew_foresi_search_backfill/`.
- Latest executive packet: `/Users/mark/Property_Analytics/reports/adhoc_executive/organic_nonbrand_search_terms/20260904_122516_andrew-foresi-portfolio-non-branded-organic-search-performance-by-group/`. It passed Outlook validation and was not emailed.
