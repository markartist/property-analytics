-- Property Brief Grounding Core for POP Brief D1 environments.
-- Mirrors the app/API migration so local POP Brief deployments have the same grounding substrate.
