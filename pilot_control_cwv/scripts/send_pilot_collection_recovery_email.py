...
def send_recovery_email(
    ...
    subject = f"RESOLVED: Pilot Morning Workflow Recovered - {report_date}"
    html_body = f"""
    <html>
    ...
    sender.send_email_with_tracking(
        ...
        html_body=html_body,
        plain_text=(
            f"Pilot morning workflow recovered for {report_date}.\n"
    ...
    print(f"✅ Pilot collection recovery email sent for {report_date}")
    return True
